...
#NP from sklearn import (manifold, datasets, decomposition, ensemble, discriminant_analysis, random_projection)
#NP from sklearn.neighbors import KernelDensity
...
class Dataset(object):
    ...
    def __add__(self, other):
        return #NP ConcatDataset([self, other])
...
class Model():
    def __init__(self, dataset_name):
        ...
        if dataset_name == 'cifar10':
            #NP model_path = './pytorch-cifar/checkpoint/ckpt.t7'
            model_path = './pytorch-cifar/M2_cifar10_bd.pt'
